...
class SettingStaggeredWorkViewController: UIViewController {
    lazy var scrollView: UIScrollView = {
        ...
        scrollView.contentSize = CGSize(width: ReferenceValues.keyWindow.screen.bounds.width, height: 567 + 20)
...
extension SettingStaggeredWorkViewController: EssentialViewMethods {
    ...
    func setLayouts() {
        ...
        NSLayoutConstraint.activate([
            self.ignoringLunchTimeMarkLabel.centerYAnchor.constraint(equalTo: ignoreLunchSwitch.centerYAnchor),
